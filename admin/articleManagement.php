...
<body>
            ...
            <table class="table table-striped table-hover text-center">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="border-2 border-light bg-info align-middle">文章圖片</th>
                ...
                <tbody>
                    ...
                    foreach ($aInfo1 as $key => $aItem1) {
                        ...
                        $titl = $aDAL3->getTitlebyId($aItem1->category, 'Article');
                        ?>
                        <tr>
                            <td class="align-middle">
                                <?php echo $index ?>
                            </td>
                            <td class="align-middle" style="width: 100px;"><img
                                    src="../_uploads/Article/Image/<?php echo $aItem1->image ?>" alt="文章圖片"
                            ...
                            <td class="align-middle">
                                <a href="editArticle.php?id=<?php echo $aItem1->id ?>" class="btn btn-primary">
                                <i class="far fa-edit"></i>編輯
                                </a>
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?php echo $aItem1->id ?>">
    ...
    <script src="articleManagement.js?v=2023"></script>
</body>
